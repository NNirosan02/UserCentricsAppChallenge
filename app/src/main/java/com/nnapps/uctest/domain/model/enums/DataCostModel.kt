package com.nnapps.uctest.domain.model.enums

enum class DataCostModel(val cost: Int, val collectedData: String) {
    CONFIGURATION_OF_APP_SETTING(1, "Configuration of app settings"),
